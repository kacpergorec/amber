    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div class="flex gap-2">
                ...
                <form method="GET" action="{{ route('posts.index') }}" class="flex items-center gap-1 mt-[-2px]" >
                    <select onchange="this.form.submit()" name="per_page" class="select select-bordered select-xs w-full max-w-xs py-0 ps-2 pe-[24px]">
