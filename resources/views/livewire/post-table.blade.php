                ...
                <tr>
                    <th>
                        <div class="dropdown relative z-10">
                            <label>
                                <button class="checkbox checkbox-sm dark:bg-base-300" style="width: 20px; height: 20px" />
                            </label>
            ...
            <tbody>
                @foreach ($posts as $key => $post)
                    <tr class="ease-in-out" wire:loading.class="hidden"
                        ...
                        <td>
                            <div class="relative z-0">
                                <input class="checkbox checkbox-sm dark:bg-base-300" id="select-{{ $post->id }}"
                                    type="checkbox" checked="{{ in_array($post->id, $selectedPosts) }}"
                                    wire:loading.class="opacity-0 pointer-events-none" wire:target="selectAll"
                                    wire:model="selectedPosts" value="{{ $post->id }}" />
                        ...
                        <td>
                            <span class="badge badge-ghost text-zinc-600 dark:text-zinc-400" style="--tw-bg-opacity:.5">
